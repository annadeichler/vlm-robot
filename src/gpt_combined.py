...
class GPTCookingAssistant:
    def __init__(self, api_key, image_data, 
                 base_prompt=(
            "You are a conversational cooking assistant robot in a kitchen setting, designed to help and interact with people as they prepare food. "
            ...
            "Keep your answers short and to the point, and provide helpful information based on the person’s questions. "
    ...
    def create_payload(self, user_input, table_status=None, max_tokens=50):
    ...
    def give_response(self, user_input):
        ...
        if user_input.lower() in ["exit", "quit"]:
            return "Cooking Assistant: Goodbye! Happy cooking!"
            # break
...
class GPTImageAnalyzer:
    ...
    def gpt_call(self, image_path, question="What objects are on the image and where?"):
        ...
        try:
            ...
            return "um, there is some error. Can you please try again?"
        ans = response['choices'][0]['message']['content']
        return ans
...
if __name__ == "__main__":
    ...
    cooking_assistant.gpt_call('hi, I want to cook something')
